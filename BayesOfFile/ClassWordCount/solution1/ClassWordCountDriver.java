...
public class ClassWordCountDriver{
	...
	public static void main(String[] args) throws IOException,ClassNotFoundException,InterruptedException{
		...
		job.setJarByClass(ClassWordCountDriver.class);
		job.setMapperClass(ClassWordCountMapper.class);
		job.setReducerClass(ClassWordCountReducer.class);

		job.setMapOutputKeyClass(ClassWord.class);
		job.setMapOutputValueClass(IntWritable.class);

		//设置最终输出的kv类型
		job.setOutputKeyClass(ClassWord.class);
